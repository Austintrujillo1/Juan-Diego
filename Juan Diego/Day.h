...
#define LunchURL [NSURL URLWithString:  @"http://www.google.com/calendar/feeds/skaggscatholiccenter.org_d680sh0bsndj1aalmh5ckovu8k@group.calendar.google.com/public/full?alt=json&orderby=starttime&max-results=1&singleevents=true&sortorder=ascending&futureevents=true"]
...
@property (nonatomic, strong) NSDictionary *lunchDict;
